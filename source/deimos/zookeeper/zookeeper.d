...
module deimos.zookeeper.zookeeper;
...
enum WATCHER_EVENT_XID  = -1;
enum PING_XID = -2;
enum AUTH_XID = -4;
enum SET_WATCHES_XID = -8;

/* zookeeper state constants */
enum EXPIRED_SESSION_STATE_DEF = -112;
enum AUTH_FAILED_STATE_DEF =  -113;
enum CONNECTING_STATE_DEF = 1;
enum ASSOCIATING_STATE_DEF = 2;
enum CONNECTED_STATE_DEF = 3;
enum READONLY_STATE_DEF = 5;
enum NOTCONNECTED_STATE_DEF = 999;

/* zookeeper event type constants */
enum CREATED_EVENT_DEF = 1;
enum DELETED_EVENT_DEF = 2;
enum CHANGED_EVENT_DEF = 3;
enum CHILD_EVENT_DEF =  4;
enum SESSION_EVENT_DEF = -1;
enum NOTWATCHING_EVENT_DEF = -2;
...
//__gshared Id ZOO_ANYONE_ID_UNSAFE = {"world\0".ptr, "anyone\0".ptr};
/** This Id is only usable to set ACLs. It will get substituted with the
 * Id's the client authenticated with.
 */
//__gshared Id ZOO_AUTH_IDS = {"auth\0".ptr, "\0".ptr};

//static __gshared ACL[] _OPEN_ACL_UNSAFE_ACL = {{0x1f, {"world", "anyone"}}};
//static __gshared ACL[] _READ_ACL_UNSAFE_ACL = {{0x01, {"world", "anyone"}}};
//static __gshared ACL[] _CREATOR_ALL_ACL_ACL = {{0x1f, {"auth", ""}}};

/** This is a completely open ACL*/
//__gshared ACL_vector ZOO_OPEN_ACL_UNSAFE = { 1, _OPEN_ACL_UNSAFE_ACL};
/** This ACL gives the world the ability to read. */
//__gshared ACL_vector ZOO_READ_ACL_UNSAFE = { 1, _READ_ACL_UNSAFE_ACL};
/** This ACL gives the creators authentication id's all permissions. */
//__gshared ACL_vector ZOO_CREATOR_ALL_ACL = { 1, _CREATOR_ALL_ACL_ACL};
...
void zoo_create_op_init(zoo_op_t *op, const char *path, const char *value,
        int valuelen,  const ACL_vector *acl, int flags, 
 ...
 */
void zoo_delete_op_init(zoo_op_t *op, const char *path, int version_);
...
void zoo_set_op_init(zoo_op_t *op, const char *path, const char *buffer, 
        int buflen, int version_, Stat *stat);
 ...
 *    actual version of the node does not match the expected version.
 */
void zoo_check_op_init(zoo_op_t *op, const char *path, int version_);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_acreate(zhandle_t *zh, const char *path, const char *value, int valuelen, const  ACL_vector *acl, int flags,string_completion_t completion, const void *data);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_adelete(zhandle_t *zh, const char *path, int version_,  void_completion_t completion, const void *data);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_aset(zhandle_t *zh, const char *path, const char *buffer, int buflen,int version_, stat_completion_t completion, const void *data);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_aset_acl(zhandle_t *zh, const char *path, int version_, ACL_vector *acl, void_completion_t, const void *data);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_create(zhandle_t *zh, const char *path, const char *value,int valuelen, const ACL_vector *acl, int flags,char *path_buffer, int path_buffer_len);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_delete(zhandle_t *zh, const char *path, int version_);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_wexists(zhandle_t *zh, const char *path, watcher_fn watcher, void* watcherCtx, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_get(zhandle_t *zh, const char *path, int watch, char *buffer, int* buffer_len, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_wget(zhandle_t *zh, const char *path, watcher_fn watcher, void* watcherCtx, char *buffer, int* buffer_len, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_set(zhandle_t *zh, const char *path, const char *buffer, int buflen, int version_);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_set2(zhandle_t *zh, const char *path, const char *buffer, int buflen, int version_, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_get_children(zhandle_t *zh, const char *path, int watch, String_vector *strings);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_wget_children(zhandle_t *zh, const char *path, watcher_fn watcher, void* watcherCtx, String_vector *strings);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_get_children2(zhandle_t *zh, const char *path, int watch, String_vector *strings, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_wget_children2(zhandle_t *zh, const char *path, watcher_fn watcher, void* watcherCtx, String_vector *strings, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_get_acl(zhandle_t *zh, const char *path, ACL_vector *acl, Stat *stat);
 ...
 * ZMARSHALLINGERROR - failed to marshall a request; possibly, out of memory
 */
 int zoo_set_acl(zhandle_t *zh, const char *path, int version_, const ACL_vector *acl);
